...
![alt text]({{ imagePostPath }}feedback-twitter@2x.gif "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}feedback-facebook@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}save-textedit@2x.png "Logo Title Text 1")

**Хорошо: сохранение в Google Docs.** При закрытии Google Docs, документ сохраняется всегда. Никаких запросов нет.

![alt text]({{ imagePostPath }}save-googledocs@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}scroll-word@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}version-notesapp@2x.jpg "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}firefox-download@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}chrome-download@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}windows-history@2x.jpg "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}dropbox-history@2x.gif "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}windows-antivirus@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}bookmark-chrome@2x.png "Logo Title Text 1")
...
![alt text]({{ imagePostPath }}bookmark-chromegood@2x.png "Logo Title Text 1")
