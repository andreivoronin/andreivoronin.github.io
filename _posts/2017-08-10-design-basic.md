...
![Windows app close](/images/design-basic/windows-app-close.png)
...
![Feedback Twitter](/images/design-basic/feedback-twitter.gif)
...
![Feedback Facebook](/images/design-basic/feedback-facebook.png)
...
![Open Twitter](/images/design-basic/open-twitter.webp)
...
![Save TextEdit](/images/design-basic/save-textedit.png)

**Хорошо: сохранение в Google Docs.** При закрытии Google Docs, документ сохраняется всегда. Никаких запросов нет.

![Save Google Docs](/images/design-basic/save-googledocs.png)
...
![Scroll Word](/images/design-basic/scroll-word.png)
...
![Version Notes.app](/images/design-basic/version-notesapp.jpg)
...
![Version Google Docs](/images/design-basic/version-googledocs.gif)
...
![Firefox download](/images/design-basic/firefox-download.png)
...
![Chrome download](/images/design-basic/chrome-download.png)
...
![Windows history](/images/design-basic/windows-history.jpg)
...
![Dropbox history](/images/design-basic/dropbox-history.gif)
...
![Kaspersky antivirus](/images/design-basic/kaspersky-antivirus.png)
...
![Windows antivirus](/images/design-basic/windows-antivirus.png)
...
![Bookmark Chrome](/images/design-basic/bookmark-chrome.png)
...
![Bookmark Chrome Good](/images/design-basic/bookmark-chromegood.png)
